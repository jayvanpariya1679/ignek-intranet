package com.ignek.intranet.employeerest.internal.graphql.mutation.v1_0;
...
public class Mutation {
	...
	@GraphQLField
	public Employee updateEmployee(@GraphQLName("employee") Employee employee)
		throws Exception {

		return _applyComponentServiceObjects(
			_employeeResourceComponentServiceObjects,
			this::_populateResourceContext,
			employeeResource -> employeeResource.updateEmployee(employee));
	}
