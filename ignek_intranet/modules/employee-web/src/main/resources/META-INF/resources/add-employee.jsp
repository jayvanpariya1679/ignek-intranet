	...
	<div class="form-body">
		...
		<aui:form action="<%=addEmployeeActionURL%>" name="employeeForm"
			...
			<div class="name-input">
				<aui:input cssClass="first-name" name="firstName" label="First Name"
					placeholder="Enter your first name">
					<aui:validator name="required" />
					<aui:validator name="alpha" />
				</aui:input>
				<aui:input cssClass="last-name" name="lastName" label="Last Name"
			...
			<div class="addressline-input">
				...
				<aui:input cssClass="address-2" label="Address Line 2"
					name="addressLine2" placeholder="Enter your street / lane / area">
					<aui:validator name="required" />
					<aui:validator name="string" />
				</aui:input>
			</div>
			...
			<div class="city-zip-input">
				...
				<aui:input cssClass="zip-input" label="Post Code/ Zip Code"
					name="zipCode" placeholder="Enter your post code/ zip code">
					<aui:validator name="required" />
					<aui:validator name="maxLength">10</aui:validator>
				</aui:input>
			</div>
