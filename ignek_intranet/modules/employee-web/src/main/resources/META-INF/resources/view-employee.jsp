...
<aui:form method="post" >
	<aui:input name="empId" type="hidden" value="<%=Long.parseLong(empId)%>" readonly="true"/>
	
	<div class="name-input">
	<aui:input cssClass="first-name" label="First Name" name="firstName" type="text" value="${firstName}" readonly="true"/>
	<aui:input cssClass="last-name" label="Last Name" name="lastName" type="text" value="${lastName}" readonly="true"/>
	</div>
	
	<div class="designation-form">
	<aui:input cssClass="designation-body" label="Designation" name="designation" type="text" value="${designation}" readonly="true"/>
	</div>

	<div class="email-phone-input">
	<aui:input cssClass="phone" label="Phone" name="phoneNumber" type="text" value="<%=Long.parseLong(phoneNumber)%>" readonly="true"/>
	<aui:input cssClass="email" label="Email" name="emailAddress" type="text" value="${emailAddress}" readonly="true"/>
	</div>
	
	<div class="addressline-input">
	<aui:input cssClass="address-1" label="Address Line 1" name="addressLine1" type="text" value="${addressLine1}" readonly="true"/>
	<aui:input cssClass="address-2" label="Address Line 2" name="addressLine2" type="text" value="${addressLine2}" readonly="true"/>
	</div>
	
	<div class="city-zip-input">
	<aui:input cssClass="city-input" label="City" name="city" type="text" value="${city}" readonly="true"/>
	<aui:input cssClass="zip-input" label="Post Code/ Zip Code" name="zipCode" type="text" value="${zipCode}" readonly="true"/>
	</div>
</aui:form>
</div>
</div>