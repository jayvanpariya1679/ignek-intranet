...
<%@ page import="com.ignek.intranet.employee.portlet.EmployeeWebPortlet"%>
...
<div class="portlet-background">
  ...
  <liferay-ui:search-container total="<%=employeeList.size() %>" delta="10" emptyResultsMessage="no-students-found" iteratorURL="<%=iteratorURL%>" cssClass="table table-employee">
    ...
    <liferay-ui:search-container-row cssClass="table-row" className="com.ignek.intranet.employee.model.Employee" modelVar="emp" keyProperty="empId">
