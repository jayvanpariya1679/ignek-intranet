...
import com.ignek.intranet.employee.model.EmployeeModel;
...
/**
 * The base model implementation for the Employee service. Represents a row in the &quot;IgnekIntranet_Employee&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class EmployeeModelImpl
	 ...
	 */
	public static final String TABLE_NAME = "IgnekIntranet_Employee";
	...
	static {
		...
		attributeGetterFunctions.put("addressLine1", Employee::getAddressLine1);
		attributeSetterBiConsumers.put(
			"addressLine1",
			(BiConsumer<Employee, String>)Employee::setAddressLine1);
		attributeGetterFunctions.put("addressLine2", Employee::getAddressLine2);
		attributeSetterBiConsumers.put(
			"addressLine2",
		...
		attributeSetterBiConsumers.put(
			"zipCode", (BiConsumer<Employee, Long>)Employee::setZipCode);
	...
	public Employee cloneWithOriginalValues() {
		...
		employeeImpl.setZipCode(this.<Long>getColumnOriginalValue("zipCode"));
